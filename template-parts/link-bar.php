...
<!-- Mobile Icons Block --------------------->
    <div class="mobile-icons">
            ...
            <?php // Autograph Icon & Link ----------------------------->
                $link = get_field( 'celeb_auto_url', 'option' ) ?: array( 'url' => '#', 'target' => '' );
                $icon = get_field( 'celeb_auto_ico', 'option' ) ?: '';
            ?>
                    <a href="<?php echo esc_url( $link['url'] ); ?>" 
                    target="<?php echo esc_attr( $link['target'] ); ?>">
                        <?php echo $icon; ?>
