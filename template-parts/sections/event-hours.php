...
/** Template Part: Content-Blocks Section - Event Hours
 ...
 * - Pulls from Content Boxes on Event-Info Page & ACF fields from Schedule & Hours Options Page
 * 
 * To Do: 
 * - Add to Calendar Option 
 * 
 * - Days View Toggle (lower priority)
*/

?>
<!-- Content Blocks Section ------------------------->
<div class=""> 
<div class="self-centered "><!-- Section Background -->         
    <div class="content-blocks-sec self-centered-stretch">
        <!-- Content Block 1 ---------------------->
...
</div><!-- END Ticket Comparison Section ----------------------->
