...
/** Template Part: Comparison Chart
 * FanX Theme 2026
 * 
 * Notes: Veiw Layout in Design Notebook 
 * - Used on Ticket Info Page 
...
<div class="ticket-compare self-centered"><!-- Section Background -->
    <div class="ticket-cb-sec self-centered grid-bkgrnd"><!-- Pink/White Grid Background -->   
        
        <!-- Content Blocks -->      
        <div class="tkt-content-blocks-sec self-centered-stretch">

            <!-- Ticket Comparison Chart -Content Block 1 ---------------------->
            <div class="ticket-cb tkt-content-blocks block">
                <h2 class="tkt-cb outline">
            ...
            <!--- Ticket Comparison Chart - Content Block 2 ---------------------->
            <div class="ticket-cb tkt-content-blocks block">
                <h2 class="tkt-cb outline">
            ...
            <!--- Ticket Comparison Chart - Content Block 3 ---------------------->
            <div class="ticket-cb tkt-content-blocks block">
                <h2 class="tkt-cb outline">
